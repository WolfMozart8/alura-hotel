...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBackground(Color.green);
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
					...
					int fechaMayor = txtFechaSalida.getDate().compareTo(txtFechaEntrada.getDate());
					if (fechaMayor > 0) {
						txtValor.setText("$" + calcularValorReserva().toString());
					}else {
						JOptionPane.showMessageDialog(null, "Selecciona una fecha correcta");
					}
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					...
					String formatDate2 = dateFormat.format(txtFechaSalida.getDate());

					int pagoSeleccionado = txtFormaPago.getSelectedIndex();
					FormaDePago formaPago = FormaDePago.obtenerPorIndice(pagoSeleccionado);

					LocalDate fecha1 = LocalDate.parse(formatDate1);
					LocalDate fecha2 = LocalDate.parse(formatDate2);

					Reserva reserva = new Reserva(fecha1, fecha2, formaPago);
					reservaController.insertar(reserva);
...
//		});
	...
	private BigDecimal calcularValorReserva() {
		...
		int diferencia = fecha1.until(fecha2).getDays();
		Long chronoTIme = ChronoUnit.DAYS.between(fecha1, fecha2);

		BigDecimal total = new BigDecimal(chronoTIme).multiply(ReservaValores.getValorDia());
